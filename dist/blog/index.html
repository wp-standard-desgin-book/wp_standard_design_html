		...
		<header id="masthead" class="header">
			...
			<div class="container">
				...
				<div class="header-logo">
					<a href="../index.html">
						<img src="../images/logo.png" alt="OzoneCafe">
					</a>
					<!-- /ロゴ -->
				</div>
				...
				<nav class="header-navigation">
					...
					<ul class="nav-menu">
						...
						<li>
							...
							<ul class="sub-menu">
								<li>
									<a href="../shop/taste.html">こだわり</a>
								</li>
								<li>
									<a href="../shop/history.html">歴史</a>
								</li>
							</ul>
						</li>
						...
						<li>
							...
							<ul class="sub-menu">
								<li>
									<a href="../recruit/form.html">応募フォーム</a>
								</li>
							</ul>
						</li>
			...
			<div class="container">
				...
				<div id="main-content" class="l-main site-main">
					...
					<div class="content-area posts">
						<div class="site-content" role="main">
							...
							<article class="post blog-archive">
								...
								<div class="entry-content">
									<article id="post-1" class="post hentry">
										...
										<header class="entry-header">
											...
											<h1 class="entry-title">
												<a href="../blog/article01.html">サイトをオープンしました。</a>
											</h1>

											<div class="entry-meta">

												<span class="date">
													<time class="entry-date">2014年9月22日</time>
												</span>

												<span class="categories-links info">
													<a href="#" rel="category">新着情報</a>
												</span>
											</div>
										</header>
									...
									<article id="post-2" class="post hentry">
										...
										<header class="entry-header">
											...
											<div class="entry-meta">
												...
												<span class="categories-links limited">
													<a href="#" rel="category">期間限定</a>
												</span>
											</div>
										...
										<div class="entry-content">
											<div class="thumbnail">
												<img src="../images/menu08-thumbnail01.png" alt="季節のショートケーキ">
											</div>
				...
				<aside id="secondary" class="l-sidebar">
					...
					<div class="banner">
						...
						<p>
							<a href="../contact.html">
								<img src="../images/banner-contact.png" alt="お問い合わせ">
							</a>
						</p>

						<p>
							<a href="../shop/index.html#access">
								<img src="../images/banner-access.png" alt="アクセス">
							</a>
						</p>

						<p>
							<a href="../blog/index.html">
								<img src="../images/banner-blog.png" alt="ブログ">
							</a>
						</p>
		...
		<footer id="colophon" class="footer text-center">
			...
			<div class="container">
				...
				<div class="footer-logo">
					<a href="../index.html">
						<img src="../images/footer-logo.png" alt="OzoneCafe">
					</a>
